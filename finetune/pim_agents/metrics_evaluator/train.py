"""
Fine-tune DistilBERT for Metrics Evaluator Classification.

Classifies committee signals:
- STRONG_BUY, BUY, NEUTRAL, SELL, STRONG_SELL

Usage:
    python generate_training_data.py --output data --count 200
    python train.py --data data --output models/metrics_evaluator
"""
...
class MetricsDataset(Dataset):
    """PyTorch dataset for metrics/signal classification."""
...
def train(
    ...
    """Fine-tune DistilBERT on signal classification."""
    ...
    train_dataset = MetricsDataset(data_dir / "train.jsonl", tokenizer, max_length)
    val_dataset = MetricsDataset(data_dir / "val.jsonl", tokenizer, max_length)
...
def export_to_onnx(model, tokenizer, output_dir: Path, max_length: int = 128):
    ...
    try:
        ...
        dummy_input = tokenizer(
            "Committee vote: 5/7 agents recommend LONG",
            return_tensors="pt",
            padding="max_length",
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", type=str, default="models/metrics_evaluator")
